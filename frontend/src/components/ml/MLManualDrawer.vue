<template>
  ...
  >
    <a-layout class="drawer-layout">
      ...
      <a-layout-content class="drawer-content">
        <a-typography>
          <a-typography-title :level="2">{{ getContentTitle }}</a-typography-title>
...
<style scoped>
.ml-manual-drawer :deep(.ant-drawer-body) {
  padding: 0;
  overflow: hidden;
}
