      ...
      <a-card :bordered="false">
        <a-tabs v-model:activeKey="activeTabKey">
          ...
          <a-tab-pane key="pending" tab="待审批">
            ...
            <a-table
              :loading="loading.practiceApprovals"
              :dataSource="pendingPracticeApprovals"
          ...
          <a-tab-pane key="approved" tab="已审批">
            ...
            <a-table
              :loading="loading.practiceApprovals"
              :dataSource="approvedPracticeApprovals"
...
// 审批列表数据
const pendingPracticeApprovals = computed(() => adminCourseStore.pendingPracticeApprovals);
const approvedPracticeApprovals = computed(() => adminCourseStore.approvedPracticeApprovals);
...
// 页面加载时获取数据
onMounted(async () => {
  await adminCourseStore.fetchPracticeApprovals();
});
...
const applyPendingFilters = () => {
  adminCourseStore.setFilter('practiceApproval', 'keyword', filters.pending.keyword);
  adminCourseStore.setFilter('practiceApproval', 'applicant', filters.pending.applicant);
  adminCourseStore.setFilter('practiceApproval', 'type', filters.pending.type);
  adminCourseStore.setFilter('practiceApproval', 'appliedTimeRange', filters.pending.appliedTimeRange);
};

// 应用已审批筛选条件
const applyApprovedFilters = () => {
  adminCourseStore.setFilter('practiceApproval', 'keyword', filters.approved.keyword);
  adminCourseStore.setFilter('practiceApproval', 'applicant', filters.approved.applicant);
  adminCourseStore.setFilter('practiceApproval', 'type', filters.approved.type);
  adminCourseStore.setFilter('practiceApproval', 'appliedTimeRange', filters.approved.appliedTimeRange);
  adminCourseStore.setFilter('practiceApproval', 'status', filters.approved.status);
};
...
const resetPendingFilters = () => {
  ...
  adminCourseStore.resetFilters('practiceApproval');
};
