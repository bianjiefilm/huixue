"""
Stage 1 (变量与数据类型) TDD tests.
Red phase: all tests should FAIL on the current output/stage_01_variable_type.json.
...
JSON_PATH = PROJECT_ROOT / "output" / "stage_01_variable_type.json"
YAML_PATH = PROJECT_ROOT / "content_orchestrator" / "stages_config" / "python" / "stage_1.yaml"
