"""
Stage DC3 (HTML解析与BeautifulSoup) TDD tests.
Red phase: all tests should FAIL on the current output/stage_3_html_parsing.json.
...
JSON_PATH = PROJECT_ROOT / "output" / "stage_3_html_parsing.json"
YAML_PATH = PROJECT_ROOT / "content_orchestrator" / "stages_config" / "data_collection" / "stage_3.yaml"
