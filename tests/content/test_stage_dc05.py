"""
Stage DC5 (动态页面处理) TDD tests.
Red phase: all tests should FAIL on the current output/stage_5_dynamic_pages.json.
...
JSON_PATH = PROJECT_ROOT / "output" / "stage_5_dynamic_pages.json"
YAML_PATH = PROJECT_ROOT / "content_orchestrator" / "stages_config" / "data_collection" / "stage_5.yaml"
...
def raw_json() -> dict:
    """Load and parse the stage 5 JSON file."""
...
def stage_config(raw_json: dict) -> dict:
    """Parse stage_5.yaml expectations."""
    import yaml
