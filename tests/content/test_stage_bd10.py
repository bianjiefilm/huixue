"""
Stage BD-10 (Sqoop数据迁移工具) TDD tests.
"""
...
JSON_FILE = PROJECT_ROOT / "output" / "stage_bigdata_07-12.json"
YAML_FILE = PROJECT_ROOT / "content_orchestrator" / "stages_config" / "bigdata" / "stage_10.yaml"
