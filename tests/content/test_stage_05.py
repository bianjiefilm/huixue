"""
Stage 4 (字符串处理) TDD tests.
Red phase: all tests should FAIL on the current output/stage_05_string.json.
...
JSON_PATH = PROJECT_ROOT / "output" / "stage_05_list_tuple.json"
YAML_PATH = PROJECT_ROOT / "content_orchestrator" / "stages_config" / "python" / "stage_5.yaml"
...
def raw_json() -> dict:
    """Load and parse the stage 4 JSON file."""
...
def stage_config(raw_json: dict) -> dict:
    """Parse stage_4.yaml expectations."""
    import yaml
