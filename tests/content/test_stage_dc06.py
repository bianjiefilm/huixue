"""
Stage DC6 (API数据采集) TDD tests.
Red phase: all tests should FAIL on the current output/stage_6_api_collection.json.
...
JSON_PATH = PROJECT_ROOT / "output" / "stage_6_api_collection.json"
YAML_PATH = PROJECT_ROOT / "content_orchestrator" / "stages_config" / "data_collection" / "stage_6.yaml"
