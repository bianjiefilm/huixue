"""
Stage DC2 (HTTP协议与请求基础) TDD tests.
Red phase: all tests should FAIL on the current output/stage_2_http_basics.json.
...
JSON_PATH = PROJECT_ROOT / "output" / "stage_2_http_basics.json"
YAML_PATH = PROJECT_ROOT / "content_orchestrator" / "stages_config" / "data_collection" / "stage_2.yaml"
...
def raw_json() -> dict:
    """Load and parse the stage 2 JSON file."""
...
def stage_config(raw_json: dict) -> dict:
    """Parse stage_2.yaml expectations."""
    import yaml
