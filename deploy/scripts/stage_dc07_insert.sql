-- ============================================================
-- Stage 7: JSON/XML 数据解析
-- practice_id=4, order_in_practice=7
-- ============================================================
...
BEGIN
    ...
    INSERT INTO task_tests (task_id, case_id, input_data, expected_output, is_hidden, description, match_rule, test_order) VALUES
        (new_task_id, '1', $d7$''{\\"data\\":{\\"user\\":{\\"name\\":\\"张三\\"}}}'', ''data.user.name''$d7$, $d7$''张三''$d7$, false, $d7$''''{\\\\"data\\\\":{\\\\"user\\\\":{\\\\"name\\\\":\\\\"张三\\\\"}}}'''', ''''data.user.name''''$d7$, 'CONTAINS', 1),
        (new_task_id, '2', $d7$''{\\"data\\":{\\"items\\":[\\"a\\",\\"b\\",\\"c\\"]}}'', ''data.items.1''$d7$, $d7$''b''$d7$, false, $d7$''''{\\\\"data\\\\":{\\\\"items\\\\":[\\\\"a\\\\",\\\\"b\\\\",\\\\"c\\\\"]}}'''', ''''data.items.1''''$d7$, 'CONTAINS', 2),
        (new_task_id, '3', $d7$''{\\"name\\":\\"test\\"}'', ''name''$d7$, $d7$''test''$d7$, true, $d7$''''{\\\\"name\\\\":\\\\"test\\\\"}'''', ''''name''''$d7$, 'CONTAINS', 3),
        (new_task_id, '4', $d7$''{\\"a\\":{\\"b\\":{\\"c\\":1}}}'', ''a.x.c''$d7$, $d7$null$d7$, true, $d7$''''{\\\\"a\\\\":{\\\\"b\\\\":{\\\\"c\\\\":1}}}'''', ''''a.x.c''''$d7$, 'CONTAINS', 4),
        (new_task_id, '5', $d7$''invalid json'', ''data''$d7$, $d7$null$d7$, true, $d7$''''invalid json'''', ''''data''''$d7$, 'CONTAINS', 5),
        (new_task_id, '6', $d7$''{\\"data\\":{\\"list\\":[{\\"id\\":1},{\\"id\\":2}]}}'', ''data.list.1.id''$d7$, $d7$2$d7$, true, $d7$''''{\\\\"data\\\\":{\\\\"list\\\\":[{\\\\"id\\\\":1},{\\\\"id\\\\":2}]}}'''', ''''data.list.1.id''''$d7$, 'CONTAINS', 6),
        (new_task_id, '7', $d7$''<catalog><product id=\\"P001\\"><name>产品A</name><price currency=\\"CNY\\">99.9</price></product></catalog>''$d7$, $d7$[{''id'': ''P001'', ''name'': ''产品A'', ''price'': 99.9, ''currency'': ''CNY'', ''specs'': {}, ''tags'': []}]$d7$, true, $d7$''''<catalog><product id=\\\\"P001\\\\"><name>产品A</name><price currency=\\\\"CNY\\\\">99.9$d7$, 'CONTAINS', 7),
        (new_task_id, '8', $d7$''<catalog></catalog>''$d7$, $d7$[]$d7$, true, $d7$''''<catalog></catalog>''''$d7$, 'CONTAINS', 8)
;
