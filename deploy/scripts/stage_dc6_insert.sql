...
$dc6$,
  ...
  VALUES
    (new_task_id, 'tc_1', $dc6$"https://api.example.com/data | Bearer sk_test_123456"$dc6$, $dc6$"[{'id': 1, 'name': 'Item 1'}"$dc6$, False, '', 'CONTAINS', 1),
    (new_task_id, 'tc_2', $dc6$"https://api.example.com/users | Bearer sk_test_789012"$dc6$, $dc6$"[{'id': 1, 'name': 'User 1'}"$dc6$, False, '', 'CONTAINS', 2),
    (new_task_id, 'tc_3', $dc6$"https://api.example.com/posts | Bearer sk_live_abc123"$dc6$, $dc6$"[{'id': 1, 'title': 'Post 1'}"$dc6$, True, '', 'CONTAINS', 3),
    (new_task_id, 'tc_4', $dc6$"https://api.example.com/orders | Bearer sk_live_xyz789"$dc6$, $dc6$"[{'id': 1, 'order_id': 'ORD001'}"$dc6$, True, '', 'CONTAINS', 4),
    (new_task_id, 'tc_5', $dc6$"https://api.example.com/products | Bearer sk_prod_def456"$dc6$, $dc6$"[{'id': 1, 'name': 'Product 1'}"$dc6$, True, '', 'CONTAINS', 5),
    (new_task_id, 'tc_6', $dc6$"https://api.example.com/comments | Bearer sk_prod_ghi789"$dc6$, $dc6$"[{'id': 1, 'body': 'Comment'}"$dc6$, True, '', 'CONTAINS', 6);
END $$;