-- ============================================================
-- Stage 3: HTML解析与BeautifulSoup
-- practice_id=4, order_in_practice=3
-- ============================================================
...
INSERT INTO tasks (
    ...
    4,
    $v$HTML解析与BeautifulSoup$v$,
    'PRACTICE',
    3,
    $v$intermediate$v$,
    $v$# Stage 3: HTML 解析与 BeautifulSoup
...
BEGIN
    ...
    INSERT INTO task_tests (task_id, case_id, input_data, expected_output, is_hidden, description, match_rule, test_order) VALUES
        (new_task_id, 'case_1', $v${'html': '<html><body><a href="https://example.com">Example</a><a href="https://test.org">Test</a></body></html>'}$v$, $v$Example -> https://example.com
Test -> https://test.org$v$, false, $v${'html': '<html><body><a href="https://example.com">Example</a><a href="https://test.org">Test</a></body></html>'}$v$, 'EXACT_MATCH', 1),
        (new_task_id, 'case_2', $v${'html': '<html><body><a>无 href 链接</a><a href="https://cn.bing.com">必应</a><div>不是链接</div></body></html>'}$v$, $v$无 href 链接 -> None
必应 -> https://cn.bing.com$v$, false, $v${'html': '<html><body><a>无 href 链接</a><a href="https://cn.bing.com">必应</a><div>不是链接</div></body></html>'}$v$, 'EXACT_MATCH', 2),
        (new_task_id, 'case_3', $v${'html': '<html><body><a href="/path?param=中文&key=value">编码测试</a><a href="https://unicode.com">Unicode</a></body></html>'}$v$, $v$编码测试 -> /path?param=中文&key=value
Unicode -> https://unicode.com$v$, true, $v${'html': '<html><body><a href="/path?param=中文&key=value">编码测试</a><a href="https://unicode.com">Unicode</a></body></html>'}$v$, 'EXACT_MATCH', 3),
        (new_task_id, 'case_4', $v${'html': '<html><body><a href="https://a.com"><span class="icon">🔗</span>带图标的链接</a></body></html>'}$v$, $v$🔗带图标的链接 -> https://a.com$v$, true, $v${'html': '<html><body><a href="https://a.com"><span class="icon">🔗</span>带图标的链接</a></body></html>'}$v$, 'EXACT_MATCH', 4),
        (new_task_id, 'case_5', $v${'html': '<html><body><!-- 注释里的 <a> 链接 --><a href="https://visible.com">可见链接</a><script>document.write(\'<a href="https://invisible.com">脚本链接</a>\')</script></body></html>'}$v$, $v$可见链接 -> https://visible.com$v$, true, $v${'html': '<html><body><!-- 注释里的 <a> 链接 --><a href="https://visible.com">可见链接</a><script>document.write(\'<a href="https://invisible.com">脚本链接</a>\')</script></body></html>'}$v$, 'EXACT_MATCH', 5),
        (new_task_id, 'case_6', $v${'html': '<html><body>\n    <div class="nav">\n        <a href="/home"> 首页 </a>\n        <a href="/about"> 关于 </a>\n        <a href=""> 空 href </a>\n        <a href="https://demo.com">  示例站  </a>\n    </div>\n</body></html>'}$v$, $v$首页 -> /home
关于 -> /about
空 href -> 
示例站 -> https://demo.com$v$, true, $v${'html': '<html><body>\n    <div class="nav">\n        <a href="/home"> 首页 </a>\n        <a href="/about"> 关于 </a>\n        <a href=""> 空 href </a>\n        <a href="https://demo.com">  示例站  </a>\n    </div>\n</body></html>'}$v$, 'EXACT_MATCH', 6);
