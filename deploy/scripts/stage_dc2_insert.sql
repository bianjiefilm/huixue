...
$s2a$,
  ...
  VALUES
    (new_task_id, 'case_1', $s2a$"http://httpbin.org/status/200"$s2a$, $s2a$"200"$s2a$, False, '获取 httpbin 200 状态', 'CONTAINS', 1),
    (new_task_id, 'case_2', $s2a$"http://httpbin.org/get"$s2a$, $s2a$"200"$s2a$, False, 'GET请求到 httpbin/get', 'CONTAINS', 2),
    (new_task_id, 'case_3', $s2a$"http://httpbin.org/status/404"$s2a$, $s2a$"404"$s2a$, True, '404状态码', 'CONTAINS', 3),
    (new_task_id, 'case_4', $s2a$"http://httpbin.org/html"$s2a$, $s2a$"200"$s2a$, True, 'HTML响应页面', 'CONTAINS', 4),
    (new_task_id, 'case_5', $s2a$"http://httpbin.org/json"$s2a$, $s2a$"200"$s2a$, True, 'JSON格式响应', 'CONTAINS', 5),
    (new_task_id, 'case_6', $s2a$"http://httpbin.org/status/500"$s2a$, $s2a$"500"$s2a$, True, '服务器内部错误500', 'CONTAINS', 6);
END $$;